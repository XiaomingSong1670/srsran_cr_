...
public:
  ...
  virtual void record_cc_result(rbgmask_t cc_result){};
...
alloc_result
             try_dl_newtx_alloc_cr(sf_sched& tti_sched, sched_ue& ue, const dl_harq_proc& h, rbgmask_t* result_mask = nullptr);
