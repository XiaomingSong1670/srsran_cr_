...
/**
   * Allocate users to slices based on their QoS requirement
   * Called at RRC Layer rrc.cc line 443
   */
  void mac_controller::slice_ue_cfg(uint16_t rnti, uint8_t slice){

    mac->slice_mac_cfg(rnti, slice); 
